...
void fun2() {
    ...
    Console::puts("Writing first time\n");
    ...
    for(int j = 0;; j++) {
       ...
       /* -- Read */
       Console::puts("\n==========================================================\n");
       Console::puts("Reading a block["); Console::puti(read_block); Console::puts("] from disk\n");
       Console::puts("==========================================================\n");
       ...
       Console::puts("\n==========================================================\n");
       Console::puts("\nWriting a block["); Console::puti(write_block); Console::puts("] from disk\n");
...
#endif
#else
    SYSTEM_DISK = new MirroringDisk(MASTER, SYSTEM_DISK_SIZE);
#endif
